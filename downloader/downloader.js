window.DownloadApi = {
	converter: {
		library: _ => `https://raw.githubusercontent.com/antoinebnm/BetterDiscordAddons/master/Library/0BDFDB.plugin.js`,
		plugin: arg => `https://raw.githubusercontent.com/antoinebnm/BetterDiscordAddons/master/Plugins/${arg}/${arg}.plugin.js`,
		theme: arg => `https://raw.githubusercontent.com/antoinebnm/BetterDiscordAddons/master/Themes/${arg}/${arg}.theme.css`,
		url: arg => arg = arg.startsWith("https://") || arg.startsWith("http://") ? arg : `https://raw.githubusercontent.com/antoinebnm/BetterDiscordAddons/master/${arg}`
	},
